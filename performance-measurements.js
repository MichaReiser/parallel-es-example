...
function addMonteCarloTests(suite) {
    ...
    for (var _i = 0; _i < _arr.length; _i++) {
        var numberOfProjects = _arr[_i];var _arr2 = [Math.pow(10, 4), Math.pow(10, 5), Math.pow(10, 6)];

        for (var _i2 = 0; _i2 < _arr2.length; _i2++) {
            var numRuns = _arr2[_i2];
...
function addMandelbrotTests(suite) {
    ...
    var _loop2 = function _loop2() {
        var maxValuesPerTask = _arr3[_i3];
...
function initResultTable(event) {
    ...
    event.currentTarget.forEach(function (suite) {
        ...
        var _suite$name$split = suite.name.split(":"),
            _suite$name$split2 = _toArray(_suite$name$split),
            set = _suite$name$split2[0],
            nameParts = _suite$name$split2.slice(1);
