...
function addKnightBoardTests(suite) {
    ...
    try {
        var _loop = function _loop() {
            ...
            suite.add("Knights Tour (" + boardSize + "x" + boardSize + ") parallel-dynamic", function (deferred) {
            ...
            suite.add("Knights Tour (" + boardSize + "x" + boardSize + ") parallel-transpiled", function (deferred) {
...
function addMonteCarloTest(suite, options, numberOfProjects) {
    ...
    suite.add("Monte carlo " + numberOfProjects + " Math.random-parallel", function (deferred) {
    ...
    suite.add("Monte carlo " + numberOfProjects + " simjs-parallel", function (deferred) {
...
function addMandelbrotTests(suite) {
    ...
    var _loop2 = function _loop2() {
        ...
        var titleDynamic = "Mandelbrot " + mandelbrotOptions.imageWidth + "x" + mandelbrotOptions.imageHeight + ", " + mandelbrotOptions.iterations + " parallel-dynamic (" + maxValuesPerTask + ")";
        suite.add(titleDynamic, function (deferred) {
        ...
        var titleTranspiled = "Mandelbrot " + mandelbrotOptions.imageWidth + "x" + mandelbrotOptions.imageHeight + ", " + mandelbrotOptions.iterations + " parallel-transpiled (" + maxValuesPerTask + ")";
        suite.add(titleTranspiled, function (deferred) {
